...
const moran_mgwr = {"moran_EI":0.0003,"moran_I":0.006,"moran_p":0.109};
const moran_ols = {"moran_EI":0.0003,"moran_I":0.287,"moran_p":0.00};
...
export function ResidualNarrative (props) {
    ...
    const moranResult = key === 'ols_residual' ? moran_ols : moran_mgwr;
    ...
    const onGoodHover = () => {
        ...
        //console.log(key, filter, good_places);
    };
